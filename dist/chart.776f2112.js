...
(function _callee() {
  var myChart, body, $obs, name, numbers, url, getData, data, beerChart, info, subtract, updateChart;
  return regeneratorRuntime.async(function _callee$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          myChart = document.getElementById("myChart").getContext("2d"); // const myObserver = new ResizeObserver(entries => {
          ...
          $obs = _rxjs.default.fromEvent(body, "resize");
          $obs.pipe((0, _operators.tap)(console.log)).subscribe(function (e) {
            return console.log;
          }); // myObserver.observe(body);

          name = [];
          numbers = [];
          url = "https://api.punkapi.com/v2/beers?brewed_before=12-2008&abv_gt=6";
        ...
        case 10:
          ...
          info = beerChart.data.datasets[0].data;

          subtract = function subtract(arr) {
          ...
          updateChart = setInterval(function () {
            ...
            info.shift();
            beerChart.update();
            beerChart.data.labels.shift();
            beerChart.update();
          }, 100);
          beerChart.data.datasets[0].data.map(function (i) {
            if (i === 0) {
              beerChart.data.labels.shift();
              beerChart.update();
            }
...
},{"rxjs":"node_modules/rxjs/_esm5/index.js","rxjs/operators":"node_modules/rxjs/_esm5/operators/index.js"}],"../.nvm/versions/node/v12.13.1/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../.nvm/versions/node/v12.13.1/lib/node_modules/parcel/src/builtins/hmr-runtime.js","chart.js"], null)
